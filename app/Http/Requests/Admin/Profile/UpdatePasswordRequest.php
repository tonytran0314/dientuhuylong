...
class UpdatePasswordRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'confirm_new_password.required' => 'Bạn phải nhập xác nhận mật khẩu mới',
            'confirm_new_password.string' => 'Xác nhận mật khẩu mới chứa ký tự không được cho phép',
            'confirm_new_password.max' => 'Xác nhận mật khẩu mới không thể vượt quá 255 ký tự',
            'confirm_new_password.same' => 'Mật khẩu mới và Xác nhận mật khẩu mới không trùng nhau'
        ];
    }
}
